...
const selectTriggerStyle = tva({
    ...
    variants: {
        ...
        variant: {
            underlined:
                "border-0 border-b rounded-none data-[hover=true]:border-primary-700 data-[focus=true]:border-primary-700 data-[focus=true]:web:boxShadow-[inset_0_-1px_0_0] data-[focus=true]:web:boxShadow-primary-700 data-[invalid=true]:border-error-700 data-[invalid=true]:web:boxShadow-error-700",
            outline:
                "data-[focus=true]:border-primary-700 data-[focus=true]:web:boxShadow-[inset_0_0_0_1px] data-[focus=true]:data-[hover=true]:web:boxShadow-primary-600 data-[invalid=true]:web:boxShadow-[inset_0_0_0_1px] data-[invalid=true]:border-error-700 data-[invalid=true]:web:boxShadow-error-700 data-[invalid=true]:data-[hover=true]:border-error-700",
            rounded:
                "rounded-full data-[focus=true]:border-primary-700 data-[focus=true]:web:boxShadow-[inset_0_0_0_1px] data-[focus=true]:web:boxShadow-primary-700 data-[invalid=true]:border-error-700 data-[invalid=true]:web:boxShadow-error-700",
        },
    },
});
