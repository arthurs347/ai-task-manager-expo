...
export async function POST(request: Request) {
    ...
    switch (taskType) {
        ...
        case TaskType.AUTOMATIC:
            return new Response(JSON.stringify({ error: "Automatic task not supported" }), {
...
export async function GET(request: Request) {
    ...
    const taskType: TaskType | null = url.searchParams.get("taskType") as TaskType;
    ...
    return new Response(JSON.stringify(tasksRetrieved), { status: StatusCodes.OK });
}
